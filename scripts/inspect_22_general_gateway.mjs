...
console.log(`General Public Gateway Records: ${generalGateway.length}`);
generalGateway.forEach((g, i) => {
  console.log(`[${i+1}] ${g.buyerName} | ${g.email} | ${g.phone} | ₹${g.amount} | ${g.race} | Cust: ${g.custId} | Txn: ${g.txnId}`);
});
