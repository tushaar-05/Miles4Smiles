...
console.log(`Properly Parsed Form Rows: ${formParsed.length}`);
formParsed.forEach((r, idx) => {
  console.log(`[${idx+1}] ${r['Name']} | ${r['Email']} | URN: ${r['URN NUMBER'] || '—'} | Gender: ${r['Gender']} | Size: ${r['Select your preferred t-shirt size for the event:']} | Wt: ${r['Weight']} | Ht: ${r['Height']} | Year: ${r['Study Year']} | Phone: ${r['Phone Number '] || '—'}`);
});
