...
const SCHEDULE = [
  ...
  },
  {
    ...
    desc: 'The official horn sounds at 6:30 AM! 400+ runners step onto the track together. Run, jog, or walk for a cause!',
    icon: Flag,
    badge: 'MAIN EVENT',
    color: '#C8FF3D',
    isFeatured: true,
  ...
  },
  {
    step: '06',
    time: '09:00 AM',
    title: 'Podium & Awards Ceremony',
    sub: 'CASH PRIZES, MEDALS & CELEBRATION',
    desc: 'Podium prize distribution of ₹30,000 cash pool, finisher celebrations & felicitations!',
    icon: Award,
    badge: 'PODIUM STAGE',
    color: '#34d399',
    isFeatured: false,
    ...
    >
      ...
      <div style={{ maxWidth: '1180px', margin: '0 auto', position: 'relative', zIndex: 10 }}>
        ...
        <div style={{ textAlign: 'center', maxWidth: '760px', margin: '0 auto 75px' }}>
          ...
          >
            Experience every electric moment of race morning — from 5:30 AM bib check-in and Zumba warmup to the torch ceremony and 6:30 AM flag off!
          </p>
        </div>
