...
const FAQS: FAQItem[] = [
  {
    ...
    answer: 'Every registered runner receives an official runner bib (chest number), energy drinks, and a downloadable timing e-certificate.',
  },
  {
    id: 2,
    category: 'race',
    question: 'What time should I report on race day?',
    answer: 'Reporting and bib check-in starts at 5:30 AM. Dignitaries welcome begins at 5:50 AM, Zumba & warmup at 6:00 AM, and the Torch Bearing ceremony at 6:15 AM. The official 5K race flag-off is at 6:30 AM sharp, followed by podium awards at 9:00 AM.',
  },
  {
    id: 3,
    category: 'kit',
    question: 'When and where can general participants collect their BIB and kit (Expo)?',
  ...
  },
  {
    id: 4,
    category: 'kit',
    question: 'When and where can NST students collect their BIB and kit?',
    answer: 'NST students can collect their official BIB and kit on 4th September at NST 4th Floor from 4:00 PM to 6:00 PM.',
  },
  {
    id: 5,
    category: 'race',
    question: 'Are there hydration and medical support stations on the route?',
    answer: 'Yes! Fully stocked hydration points with water, electrolytes, and energy drinks are set up every 1.5 KM along the 5K course. Dedicated first-aid and medical support stations are deployed throughout the track.',
  },
  {
    id: 6,
    category: 'race',
